...
export const Footer = ()=>{
    ...
    <footer className="footer">
        <svg className="footer-wave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" width="100%" height="80" preserveAspectRatio="none">
    ...
    <div className="footer-content">
        <ul className="footer-ul">
            <li>
              <FontAwesomeIcon icon={faMapPin} /> Stockholm, Sweden
            </li>
            <li>
              <a className="link" href="mailto:amanda.balk@medieinstitutet.se">
                <FontAwesomeIcon icon={faEnvelope} /> Email
              </a>
            </li>
            <li>
              <a className="link" href="https://www.linkedin.com/in/amanda-balk/" target="_blank" rel="noopener noreferrer">
      ...
      © {new Date().getFullYear()} Amanda Balk
    </div>
    </footer>
    </>
}